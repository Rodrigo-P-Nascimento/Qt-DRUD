...
"}"));
        ...
        action_Cadastrar->setObjectName("action_Cadastrar");
        QIcon icon;
        ...
        action_Gerenciar_Produtos->setObjectName("action_Gerenciar_Produtos");
        QIcon icon1;
        ...
        actionSobre_o_Grupo->setObjectName("actionSobre_o_Grupo");
        QIcon icon2;
        ...
        actionAgradecimentos->setObjectName("actionAgradecimentos");
...
""));
        ...
        menu_Produto->setObjectName("menu_Produto");
        menu_Relatorio = new QMenu(menubar);
        menu_Relatorio->setObjectName("menu_Relatorio");
        menu_Funcionario = new QMenu(menubar);
        menu_Funcionario->setObjectName("menu_Funcionario");
