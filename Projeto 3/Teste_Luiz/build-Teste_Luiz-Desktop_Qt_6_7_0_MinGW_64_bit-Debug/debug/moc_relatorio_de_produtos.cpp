...
struct qt_meta_stringdata_CLASSrelatorio_de_produtosENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSrelatorio_de_produtosENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSrelatorio_de_produtosENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject relatorio_de_produtos::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSrelatorio_de_produtosENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSrelatorio_de_produtosENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSrelatorio_de_produtosENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *relatorio_de_produtos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSrelatorio_de_produtosENDCLASS.stringdata0))
